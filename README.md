...
## 🔬 Current Research
**Evaluation of National Water Model 3.0 Peak Flow Simulations**
- Analyzing NWM performance at USGS gauges in Oklahoma
- Investigating the influence of reservoir regulation on flood predictions
- Statistical validation using KGE, NSE, RMSE, and PBIAS metrics
...
### 🎯 Core Competencies
- **Design Leadership:** Led multi-functional teams in delivering hydropower and water infrastructure projects
- **Technical Analysis:** Hydrology, hydraulics, sediment, structural design, and dam-break modeling
- **Hydraulic Infrastructure:** Expert in dams, spillways, intakes, powerhouses, and conveyance systems
- **Project Management:** Full lifecycle delivery from feasibility studies, detail design to construction closeout
- **Construction Supervision:** 2+ years managing field operations, QC/QA, and contractor coordination
...
*"Bridging data science and civil engineering to build resilient water infrastructure"*
